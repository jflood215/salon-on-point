...
export const professionals: Professional[] = [
  ...
  },
  {
    ...
    galleryImages: [],
    role: "Hairstylist",
    bio: "Color Specialist • Blonding • Dimensional Color • Customized Hair\n\nWith 35+ years behind the chair, I combine experience, artistry, and an eye for detail to create beautiful, customized hair. I specialize in dimensional color, blonding, balayage, highlights, and precision cutting. Every look begins with listening and is thoughtfully designed around your features, coloring, lifestyle, and personal style. My private Platinum Hair Designs suite offers a relaxed, one-on-one experience where the focus is completely on you.",
    phone: "317-509-8819",
    suite: "Suite #4",
